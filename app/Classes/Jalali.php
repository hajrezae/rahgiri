...
class Jalali
{
    public static function jdate($format, $timestamp = '', $none = '', $time_zone = 'Asia/Tehran', $tr_num = 'fa'): string
    {
    ...
    public static function jgetdate($timestamp = '', $none = '', $timezone = 'Asia/Tehran', $tn = 'en'): array
    {
